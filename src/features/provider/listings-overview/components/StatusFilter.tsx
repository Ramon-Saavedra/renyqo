...
const GROUP_CLASS =
  "flex flex-wrap items-center gap-1 rounded-md border border-border/50 bg-background-muted p-1";
...
const BUTTON_ACTIVE =
  "border-border/50 bg-background-muted text-foreground hover:text-foreground";
...
const ATTENTION_ACTIVE =
  "border-border/50 bg-background-muted text-foreground-secondary hover:text-foreground";
