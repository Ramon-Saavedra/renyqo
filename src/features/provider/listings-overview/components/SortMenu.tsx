...
const TRIGGER_CLASS =
  "inline-flex h-8 cursor-pointer items-center gap-1.5 rounded-md border border-border-strong bg-transparent px-2.5 text-caption text-foreground hover:bg-background-muted focus-visible:outline-none focus-visible:shadow-focus";

const TRIGGER_LABEL_CLASS = "text-foreground-tertiary text-caption";
const TRIGGER_VALUE_CLASS = "font-medium text-foreground";

const MENU_CLASS =
  "absolute right-0 top-[calc(100%+0.375rem)] z-30 min-w-56 rounded-md border border-border bg-background-muted p-1 shadow-card";

const ITEM_CLASS =
  "flex w-full cursor-pointer items-center justify-between gap-2 rounded-sm px-3 py-2 text-left text-caption text-foreground hover:bg-background-subtle";
