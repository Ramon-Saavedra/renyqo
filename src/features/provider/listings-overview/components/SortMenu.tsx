...
const TRIGGER_CLASS =
  "inline-flex h-8 cursor-pointer items-center gap-1.5 rounded-md border border-border-strong bg-transparent px-2.5 text-caption text-foreground hover:bg-background-subtle focus-visible:outline-none focus-visible:shadow-focus";
