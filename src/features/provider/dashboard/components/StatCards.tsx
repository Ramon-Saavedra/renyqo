...
const CARD_CLASS =
  "flex min-h-16 flex-col justify-between gap-1 rounded-md border border-border bg-background-muted px-2 py-1.5 md:min-h-0 md:justify-start md:gap-0.5 md:px-4 md:py-3";
