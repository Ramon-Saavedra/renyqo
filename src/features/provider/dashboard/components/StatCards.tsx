...
const CARD_CLASS =
  "flex min-h-16 flex-col justify-between gap-1 rounded-md border border-border bg-background-muted px-card-x py-card-y md:min-h-0 md:justify-start md:gap-0.5";
