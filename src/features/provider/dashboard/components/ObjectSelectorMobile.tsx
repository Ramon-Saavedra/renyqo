...
const CARD_BASE =
  "w-56 shrink-0 cursor-pointer rounded-md border px-card-x py-card-y text-left focus-visible:outline-none focus-visible:shadow-focus";
const CARD_INACTIVE =
...
const SLOT_CLASS =
  "flex h-26 w-56 shrink-0 flex-col items-center justify-center gap-2 rounded-md border border-dashed border-border bg-background-muted px-card-x py-card-y text-center text-caption text-foreground-secondary";
