...
export const createListingCopy = {
  ...
  aiCapture: {
    closed: {
      title: "Immobilie mit KI erfassen",
      body: "Lade ein Exposé hoch, beschreibe die Immobilie oder sprich sie ein. Renyqo überträgt die Angaben ins Formular.",
      capabilities: ["PDF", "Text", "Sprache"] as const,
      hint: "Auswählen und starten",
      openLabel: "KI-Erfassung öffnen",
    },
    panel: {
      title: "Immobilie mit KI erfassen",
      subtitle: "Wähle, wie du die Angaben übergeben möchtest.",
      closeLabel: "KI-Erfassung schließen",
    },
    guide: {
    ...
    pdf: {
      dropTitle: "Exposé oder PDF hochladen",
      dropAction: "Datei hierher ziehen oder",
      dropActionLink: "Datei auswählen",
      dropHint: "PDF · max. 10 MB",
      remove: "Entfernen",
      ...
      errors: {
        ...
        tooLarge:
          "Die Datei überschreitet 10 MB. Bitte lade eine kleinere Version hoch.",
      },
    },
    text: {
    ...
    voice: {
      ...
      stop: "Stopp",
      cancel: "Abbrechen",
      doneLabel: "Sprachaufnahme",
      recordedSuffix: "aufgenommen",
      redo: "Neu aufnehmen",
      submit: "Angaben erkennen",
      permissionDenied:
        "Zugriff auf das Mikrofon wurde nicht erteilt. Bitte erlaube den Zugriff und versuche es erneut.",
      unsupported: "Sprachaufnahme wird in diesem Browser nicht unterstützt.",
      formatUnsupported:
        "Dieses Aufnahmeformat wird nicht unterstützt. Bitte versuche es mit einem anderen Browser.",
    },
    processing: {
    ...
    error: {
      ...
      genericBody:
        "Die Angaben konnten nicht ausgewertet werden. Bitte versuche es erneut oder wähle eine andere Eingabe.",
      rateLimitTitle: "Zu viele Anfragen",
      rateLimitBody: "Bitte warte einen Moment, bevor du es erneut versuchst.",
      networkTitle: "Netzwerkfehler",
      networkBody: "Bitte überprüfe deine Verbindung und versuche es erneut.",
      invalidBody:
        "Die Eingabe konnte nicht verarbeitet werden. Bitte prüfe sie und versuche es erneut.",
      unauthorizedTitle: "Nicht autorisiert",
      unauthorizedBody: "Bitte melde dich erneut an.",
    ...
    fieldLabels: {
      ...
      depositMonths: "Kaution",
      availableFrom: "Verfügbar ab",
      unknown: "Weitere Angabe",
      title: "Objekttitel",
